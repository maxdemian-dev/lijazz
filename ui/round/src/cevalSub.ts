// Imports disabled - kept for reference if re-enabling anti-cheat
...
export function subscribe(_ctrl: RoundController): void {
  // Disabled for live eval bar feature - allow engine analysis during games
  return;

  // Original anti-cheat code disabled:
